...
const Footer = () => {
    ...
    return (
        <footer className="footer footer-horizontal footer-center bg-[#ffffff] text-base-content rounded p-10">
  ...
  <aside>
    <p>Copyright © {new Date().getFullYear()} - All right reserved by EVENT EXPLORER Ltd</p>
  </aside>
</footer>
    );
};
